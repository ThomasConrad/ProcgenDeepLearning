# -*- coding: utf-8 -*-
"""deep-mixreg-bench.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12XXV5KeA1dQVvnRBbNiKRT2et3hazjJ2
...
eval_env = make_env(num_envs, start_level=num_levels, num_levels=num_levels,env_name=env_name)

# Define network
encoder = ImpalaModel(3,feature_dim=feature_dim)
...
while step < total_steps:
  ...
  data_point = [step, storage.get_reward().item(), validation_reward]
